...
RUNS_STR = [
    ...
    "Running faster than Bolt coz i'mma ironbot !!",
    "Runs to Marie..",
...
async def univsaye(cowmsg):
    """ For .cowsay module, ironbot wrapper for cow which says things. """
...
async def react_meme(react):
    """ Make your ironbot react to everything. """
...
@register(outgoing=True, pattern=r"^\.(?:ok|oke)\s?(.)?")
...
@register(outgoing=True, pattern=r"^\.(?:skull|skulls)\s?(.)?")
...
CMD_HELP.update({
    ...
    "\nUsage: UwU"
    "\n\n>`.react`"
    "\nUsage: Make your ironbot react to everything."
    "\n\n>`.slap` <id/jutsu>"
