...
async def spider(spdr):
    ...
    try:
        from ironbot.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from ironbot.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    try:
        from ironbot.modules.sql_helper.gmute_sql import is_gmuted
        from ironbot.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    ...
    # Check if the function running under SQL mode
    try:
        from ironbot.modules.sql_helper.gmute_sql import ungmute
    except AttributeError:
...
async def gspider(gspdr):
    ...
    # Check if the function running under SQL mode
    try:
        from ironbot.modules.sql_helper.gmute_sql import gmute
    except AttributeError:
